...
In order to support loading of multiple wallets in fint-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fint.cpp.
...
Changes to fint.cpp
----------------------
fint.cpp is the entry point into fint-qt, and as such, will require some minor modifications to provide hooks for
