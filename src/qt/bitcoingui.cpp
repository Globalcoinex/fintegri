                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fintegri Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fint address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fint: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fintegri Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fintegri Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fint"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fint addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fint addresses"));
    ...
    openAction->setStatusTip(tr("Open a Fint: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fintegri Core help message to get a list with possible Fint command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fintegri Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fint network", "", count));
}
...
{
    QString strTitle = tr("Fintegri Core"); // default title
