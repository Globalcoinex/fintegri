/* src/config/fint-config.h.  Generated from fint-config.h.in by configure.  */
/* src/config/fint-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FINT_CONFIG_H

#define FINT_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.fint.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Fint Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fint Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fint"
