...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fint features */
        {"fint", "masternode", &masternode, true, true, false},
        {"fint", "listmasternodes", &listmasternodes, true, true, false},
        {"fint", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fint", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fint", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fint", "masternodedebug", &masternodedebug, true, true, false},
        {"fint", "startmasternode", &startmasternode, true, true, false},
        {"fint", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fint", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fint", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fint", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fint", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fint", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fint", "mnbudget", &mnbudget, true, true, false},
        {"fint", "preparebudget", &preparebudget, true, true, false},
        {"fint", "submitbudget", &submitbudget, true, true, false},
        {"fint", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fint", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fint", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fint", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fint", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fint", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fint", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fint", "checkbudgets", &checkbudgets, true, true, false},
        {"fint", "mnsync", &mnsync, true, true, false},
        {"fint", "spork", &spork, true, true, false},
        {"fint", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fint", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fintd, or the -server option to fint-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fint-cli " + methodname + " " + args + "\n";
}
